...
export const ToastError: React.FC<ToastTypes> = ({ onClose, text }) => {
    return (
...
export const ToastLoader: React.FC<ToastTypes> = ({ onClose, text }) => {
    return (
        <div id="toast-loadeer" className="flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
            <div className="inline-flex flex-shrink-0 justify-center items-center w-8 h-8 rounded-lg dark:bg-green-800 dark:text-green-200">
                <Loader />
            </div>
            <div className="ml-3 text-sm font-normal">{text}</div>
...
export const ToastSuccess: React.FC<ToastTypes> = ({ onClose, text }) => {
    return (
